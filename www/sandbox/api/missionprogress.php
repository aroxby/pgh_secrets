...
<body>
<form id="userForm" method="post" action="/secrets/missionprogress.php" onKeyPress="checkSubmit(event)" target="_blank">
<div id="dataTableMaster">
<table class="bordered"><tr><td>Action</td><td><input type="text" size="30" value="/secrets/missionprogress.php" id="actionInput" /></td></tr></table>
<div id="dataTable0">
...
<div id="dataTable1">
<table class="subbordered"><tr><td>Name</td><td><input type="text" id="name1" size="30" value="password" / ></td><td>Value</td><td><input id="value1" type="text" size="30" onfocus="checkCreate(1)" value="" / ></td></tr></table>
</div>
<div id="dataTable2">
<table class="subbordered"><tr><td>Name</td><td><input type="text" id="name2" size="30" value="missionID" /></td><td>Value</td><td><input id="value2" type="text" size="30" onfocus="checkCreate(2)" value="1" / ></td></tr></table>
</div>
<div id="dataTable3">
<table class="subbordered"><tr><td>Name</td><td><input type="text" id="name3" size="30" value="" /></td><td>Value</td><td><input id="value3" type="text" size="30" onfocus="checkCreate(3)" value="" / ></td></tr></table>
</div>

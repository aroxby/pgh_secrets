...
<body>
<form id="userForm" method="post" action="/secrets/badgeimage.php" onKeyPress="checkSubmit(event)" target="_blank">
<div id="dataTableMaster">
<table class="bordered"><tr><td>Action</td><td><input type="text" size="30" value="/secrets/badgeimage.php" id="actionInput" /></td></tr></table>
<div id="dataTable0">
<table class="bordered"><tr><td>Name</td><td><input type="text" id="name0" size="30" value="missionID"/ ></td><td>Value</td><td><input id="value0" type="text" size="30" onfocus="checkCreate(0)" value="1"/ ></td></tr></table>
</div>
<div id="dataTable1">
<table class="subbordered"><tr><td>Name</td><td><input type="text" id="name1" size="30" value="badgeNumber" / ></td><td>Value</td><td><input id="value1" type="text" size="30" onfocus="checkCreate(1)" value="3" / ></td></tr></table>
</div>
<div id="dataTable2">

...
<body>
<form id="userForm" method="post" action="/secrets/usermissions.php" onKeyPress="checkSubmit(event)" target="_blank">
<div id="dataTableMaster">
<table class="bordered"><tr><td>Action</td><td><input type="text" size="30" value="/secrets/usermissions.php" id="actionInput" /></td></tr></table>
<div id="dataTable0">
